...
<head>
	...
	<title>English Language (A) Assessment Test</title>
	
	<p>Directions: Each of the sentences given below contains one underlined word. Beneath each sentence there are four options marked A_D. Select the option which is nearest in meaning to the underlined word in the sentence.</p>
